              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      "Pendapatan",
                      style: TextStyle(color: Color(0xFFeaeaea), fontSize: 17.sp, fontWeight: FontWeight.w500),
                    ),
                        ...
                        Expanded(
                          child: Column(
                            children: [
                              Text(
                                "Hari ini",
                                style: TextStyle(color: Color(0xFFeaeaea), fontSize: 15.sp, fontWeight: FontWeight.w100),
                              ),
                              SizedBox(height: 3.h),
                              Obx(() => Text(
                                ...
                                children: [
                                  ...
                                  Column(
                                    children: [
                                      Text(
                                        "Dilayani",
                                        style: TextStyle(color: Color(0xFF1E2857), fontSize: 15.sp, fontWeight: FontWeight.w500),
                                      ),
                                      SizedBox(height: 3.h),
                                      Obx(() => Text(
