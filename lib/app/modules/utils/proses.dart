    ...
    return Container(
      child: Obx(() {
        if (controller.isLoading.value) {
          ...
          datadummy = [
            {
              "status": "menunggu",
              "transaksi": {
                "kode_tr": "TRDKN1709271386",
                "status_konfirm": null,
                "status_pesanan": null,
                "tanggal": "2024-02-23 00:39:13",
                "id_customer": "CUST69844",
                "id_kurir": null,
                "total_bayar": 0,
                "total_harga": 3500,
                ...
                "model_pembayaran": "qris",
                "created_at": "2024-02-22T17:39:13.000000Z",
                "updated_at": "2024-02-22T17:39:13.000000Z",
                "detail_transaksi": [
                  {
                    "kode_tr": "TRDKN5125870659",
                    "QTY": 30,
                    "subtotal_bayar": 3500,
                    "kode_menu": 52,
          ...
          final pesanan = Pesanan.fromJson(
              {"data": datadummy, "code": 200, "status": true});
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              final orderData = pesanan.data![index];
