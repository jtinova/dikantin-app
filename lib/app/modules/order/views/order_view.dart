                    ...
                    children: [
                      ...
                      Obx(
                        () => ElevatedButton(
                          ...
                          onPressed: () async {
                            if (orderController.isButtonEnabled.value) {
                              // Menonaktifkan tombol
                              orderController.isButtonEnabled.value = false;
                              if (homeController.cartList.isNotEmpty) {
                                ...
                                if (profileController
                                  ...
                                  bool insideCampus =
                                      controllerMaps.isInsideCampus(LatLng(
                                  ...
                                  if (insideCampus) {
                                    ...
                                    orderController.isButtonEnabled.value =
                                        true;
                                ...
                                orderController.isButtonEnabled.value = true;
                              }
                            }
                          },
                          child: Text(
